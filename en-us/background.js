...
// Main types (used very often) – stay as they were
...
// Additional types taken from the MS-List → Submenu „Divers“
const CONTEXT_TYPES_DIVERS = {
  ...
  // Container (MS-List, additional to aks/acr/aca/aci)
  ...
  // Networking (additional to the main types)
  cdnp:  "CDN profile (cdnp)",
  cdne:  "CDN endpoint (cdne)",
  con:   "Connection (con)",
  dnsfrs:"DNS forwarding ruleset (dnsfrs)",
  dnspr: "DNS Private Resolver (dnspr)",
  inep:  "DNS resolver inbound endpoint (in)",   // 'in' renamed -> inep
  outep: "DNS resolver outbound endpoint (out)", // 'out' renamed -> outep
...
// create contextmenus during installation & update
...
// handle click event → Content Script generates the selected type of name
