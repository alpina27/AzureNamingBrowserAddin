// Azure Naming Helper - Content Script (mit Divers-Auswahl)

let lastFocusedInput = null;
let quickMenuEl = null;

/* -------------------------------------------------------
   1) RESOURCE-SPECIFIC NAMING RULES (für Validierung)
--------------------------------------------------------- */
...
// Gleiche Haupttypen wie im Kontextmenü
...
// Divers-Typen: wie in background.js
...
/* -------------------------------------------------------
   8) FLOATING BUTTON + QUICK-MENÜ (inkl. Divers)
--------------------------------------------------------- */
